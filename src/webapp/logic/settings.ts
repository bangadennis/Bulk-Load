...
export default class Settings {
    ...
    public markCompletedOnImport: boolean;
    ...
    constructor(options: Options) {
        ...
        this.markCompletedOnImport = options.markCompletedOnImport;
    }
    ...
    static async build(api: D2Api, compositionRoot: CompositionRoot): Promise<Settings> {
        ...
        return new Settings({
            ...
            markCompletedOnImport: data.markCompletedOnImport ?? defaultSettings.markCompletedOnImport,
        });
    }
